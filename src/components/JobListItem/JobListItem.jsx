				...
				<Container>
					<Row className="job-item__info--flex-end">
						<Col className="job-item__info--modified"> 
							...
							>{title}</Link>
							<div>
								<div className="text-nowrap job-item__info__text"><span className="job-item__info__label">Vị trí:</span> {positionName}</div>
							</div>
						</Col>
						<Col className="job-item__info--modified">
							<div className="text-nowrap job-item__info__text"><span className="job-item__info__label">Ngày đăng:</span> {postDate}</div> 
						</Col>
						<Col className="job-item__info--modified">
